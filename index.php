...
if (isset($_SESSION['admin_name'])) {
    ...
    <a class='link-light' href='admin_dashboard.php'>Kembali ke Dashboard Admin</a>
    </button>";
}
?>
...
<link rel="stylesheet" href="./src/assets/css/styles.min.css" />
    ...
    <div class="bagian_satu grid col-12">
        ...
        <div class="gambar_judul col-6">
            <img class="imgs" src="assets/images/kue1.png" />
        </div>
    </div>
    ...
    <div id="Produk" class="grid col-12" style="margin-top:6em;">
        ...
        <!-- <div class="col-8 judul_bagan_1_kanan">
            ...
            <div class="text_bagan_kanan">Aneka ragam olahan kue kering dan basah untuk menemani hari-hari kebersamaan
                anda bersama keluarga dan orang tersayang.</div>
        ...
        <div class="col-4 gambar_kue"><img class="imgs" src="assets/images/kue/kue2.jpg" /></div> -->

        <!-- <span class="col-12" style="margin-top: 2em;"></span> -->

        <!-- <div class="col-4 gambar_kue"><img class="imgs" src="assets/images/kue/kue3.jpg" /></div>
        <div class="col-8" style="padding: 0 0 0 2em"> -->
        <!-- <div class="judul_bagan_1" style="color: #D8B9D8;">Dessert</div>
        <div class="text_bagan">Kue dan snack manis yang dapat menemani hari-harimu dalam segala kegiatan agar tetap
            bahagia dan semangat.</div> -->
    ...
    ?>
        <div class="col-4 gambar_kue"><img class="imgs" src="<?= $link_gambar;  ?>" /></div>
        <div class="col-8" style="padding: 0 0 0 2em;">
            <div class="judul_bagan_1" style="color: #9DD2D8;"><?= $row['judul_pk'] ?></div>
            <div class="text_bagan"><?= $row['deskripsi_pk'] ?></div>
            <div class="daftar_fitur">
                <ul>
    ...
    <div id="Tentang" class="tentang_kami">
        <div class="col-12 grid">
            ...
            <div class="col-4 gambar_kami">
                <img class="imgs" src="assets/images/member-assets/hendrik.png" />
            </div>
            <div class="col-4 gambar_kami">
                <img class="imgs" src="assets/images/member-assets/cristina.png" />
            </div>
            <div class="col-4 gambar_kami">
                <img class="imgs" src="assets/images/member-assets/steven.png" />
            </div>
            ...
            <div class="col-12 text_bagan_4">
                <div>Kue kami selalu terasa sempurna bila dinikmati ketika bersama dengan keluarga, teman, pacar dan
                    menghabiskan <i>quality time</i> dengan mereka. Fluffy Cake membantu Anda menciptakan momen berharga
                    saat menyantapnya.</div>
            </div>
        ...
        <div class="grid">
            <div class="col-12">
                ...
                <div class="col-12 grid_daftar grid_tengah daftar">
                    ...
                    <div class="col-11">Silahkan kunjungi link WhatsApp atau Instagram kami yang tertera di info kontak.
                    </div>
                </div>
                <div class="col-12 grid_daftar grid_tengah daftar">

                    <span class="col-1" style="text-align: center;">2</span>
                    <div class="col-11">Awali chat dengan mengisi form pemesanan pelanggan yang berisi nama, alamat,
                ...
                <div class="col-12 grid_daftar grid_tengah daftar">
                    ...
                    <div class="col-11">Cantumkan kata-kata yang diinginkan pada form jika Anda menginginkan ada
                ...
                <div class="col-12 grid_daftar grid_tengah daftar">
                    ...
                    <div class="col-11">Metode pembayaran akan dikirim saat pengisian form selesai. Tersedia pilihan:
    ...
    <div class="footer">
        <footer class="col-12 grid grid_tengah">
            <div class="col-3">
                ...
                <div class="footer2_teks">Kue Ulang tahun, Pudding Hias, Lapis Legit, dan Kue Kering khas Pontianak.
                </div>
            </div>
            ...
            <p class="col-12" style="text-align: center; margin-bottom: -1em; font-family:pelight;">@Copyright 2023. All
                rights reserved.</p>
        </footer>
    </div>
